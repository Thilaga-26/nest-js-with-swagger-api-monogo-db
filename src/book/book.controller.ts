...
export class BookController {
  ...
  @Post()
  @ApiCreatedResponse({description: 'The record has been successfully created.', type : Book})
  @ApiBadRequestResponse({description: 'The record has been not created, please try again.'})
